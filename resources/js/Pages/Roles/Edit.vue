      ...
      <div class="mx-auto max-w-2xl sm:px-6 lg:px-8">
        <div class="bg-white p-6 shadow-sm sm:rounded-lg">
          ...
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <div>
              ...
              <div class="flex flex-wrap gap-3">
                ...
                >
                  <input type="checkbox" v-model="form.permissions" :value="perm.id" class="accent-blue-600"/>
          ...
          <div class="mt-8 bg-gray-50 p-4 rounded shadow">
            ...
            <p><span class="font-medium text-gray-600">Role ID:</span> {{ role.id }}</p>
            <p><span class="font-medium text-gray-600">Created:</span> {{ role.created_at ? new Date(role.created_at).toLocaleDateString() : 'N/A' }}</p>
            <p><span class="font-medium text-gray-600">Last Updated:</span> {{ role.updated_at ? new Date(role.updated_at).toLocaleDateString() : 'N/A' }}</p>
          </div>
