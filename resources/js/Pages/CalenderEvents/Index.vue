      ...
      <table class="min-w-full">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <tr v-for="event in events" :key="event.id" class="hover:bg-gray-50">
            ...
            <td class="px-6 py-4 text-sm text-gray-500">{{ event.enrollmentss?.title || '-' }}</td>
